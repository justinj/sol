...
class Permutation {
  constructor(spec) {
    ...
    // TODO: `solved` should be more like `identity`, because it's not necessarily solved
    let solved = buildList(spec.size, buildList.id);
    let initialState = spec.initialState || solved;
