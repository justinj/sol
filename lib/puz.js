...
// TODO: We should make the ordering of the components explicit, because I
// think right now it's implicit in the order they come out of Object.keys
class Puz {
  constructor(spec) {
  ...
  // TODO: document this guy in README
  createIndexArray(state) {
    let componentNames = Object.keys(this.components);
    return mapcat(name => this.components[name].createIndexArray(state[name]), componentNames);
  }
}

// TODO: consistent ordering of methods
