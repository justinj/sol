...
describe("creating invalid", function() {
  ...
  it("throws an error if it has a move that doesn't have both perm and orie", function() {
    assertThrowsMsg("Move 'F' missing perm.", function() {
      new Orie({
        kind: Orie.kinds.zero_sum,
        size: 7,
        order: 3,
    ...
    assertThrowsMsg("Move 'F' missing orie.", function() {
      new Orie({
        kind: Orie.kinds.zero_sum,
        size: 7,
        order: 3,
  ...
  it("throws an error if it has a move whose perm or orie is the wrong length", function() {
    assertThrowsMsg("Orie on orientation move 'F' had length 6, expected length 7.", function() {
      new Orie({
        kind: Orie.kinds.zero_sum,
        size: 7,
        order: 3,
  ...
  it("verifies the ories and perms of a move are valid", function() {
    assertThrowsMsg("[3, 0, 0, 0, 0, 0, 0] is not a valid orientation for an orientation with order 3.", function() {
      new Orie({
        kind: Orie.kinds.zero_sum,
        size: 7,
        order: 3,
  ...
  it.skip("verifies that moves defined in terms of other moves bottom out eventually", function() {
    ...
    assertThrowsMsg("Orie move definitions create a cycle: U -> F -> U.", function() {
      new Orie({
        kind: Orie.kinds.zero_sum,
        size: 7,
        order: 3,
  ...
  it.skip("does not allow moves defined as algs to be defined in terms of other moves defined as algs", function() {
    assertThrowsMsg("Moves cannot be defined in terms of other moves if those moves are not explicitly defined", function() {
      new Orie({
        kind: Orie.kinds.zero_sum,
        size: 7,
        order: 3,
